  ...
  */
  ...
  // small changes made in 2009 by Hugues Luc BRUANT <non.deterministic.finite.organism@gmail.com>
  // -> the uppercase/lowercase conversion of on-calc name now honors cli params
  // -> the size of the program buffer has been increased to 65kib (XOS supports file size up to
  // 65536bytes in theory)
...
int main (int argc, char *argv[])
{
  ...
  short int uppercase = false,executable = false;
  unsigned char buffer, optiondefs = 0;
  unsigned char programData[65000];
